...
Begin VB.Form frmAbout 
   ...
   Begin VB.Label lblDescription 
      Caption         =   "Logiciel de création de Mindmap. Téléchargeable sur http://www.home.ch/~spaw4758"
      ForeColor       =   &H00000000&
      Height          =   1170
      Left            =   1050
      TabIndex        =   3
   ...
   Begin VB.Label lblDisclaimer 
      Caption         =   "Ce logiciel est en libre accès, cependant, l'auteur, C.Dutoit, se reserve tout droit sur ce logiciel."
      ForeColor       =   &H00000000&
      Height          =   825
      Left            =   255
      TabIndex        =   4
...
Private Sub Form_Load()
    Me.Caption = LoadResString(OfsLanguage + 403) & App.Title
    lblVersion.Caption = "Version " & App.Major & "." & App.Minor & "." & App.Revision
    lblTitle.Caption = App.Title
    cmdSysInfo.Caption = LoadResString(OfsLanguage + 402)
    lblDescription.Caption = LoadResString(OfsLanguage + 400)
    lblDisclaimer.Caption = LoadResString(OfsLanguage + 401)
End Sub
...
Public Sub StartSysInfo()
    ...
    Exit Sub
SysInfoErr:
    MsgBox LoadResString(OfsLanguage + 404), vbOKOnly
End Sub
